...
public class ToutParcourirFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (reserv.getColumnModel().getColumnCount() > 0) {
            reserv.getColumnModel().getColumn(0).setResizable(false);
            reserv.getColumnModel().getColumn(1).setResizable(false);
            reserv.getColumnModel().getColumn(2).setResizable(false);
            reserv.getColumnModel().getColumn(3).setResizable(false);
        }
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(66, 66, 66))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 929, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(duree == 0){
            JOptionPane.showMessageDialog(this, "Veuillez choisir une date de debut et de fin" ,"Erreur",JOptionPane.ERROR_MESSAGE);
            
        }else{
            RecapCommande rc;
            try {
                rc = new RecapCommande();
    ...
    public void SelectionVoiture(){
        try{
            ...
            if(rs.next()){
               imma = rs.getString("Immatriculation");
     ...
     void AffichageVoiture(){
        try{
            String requete = "select Marque, Modele from voitures left join location on location.Immatriculation = voitures.Immatriculation where location.Immatriculation IS NULL";
            ps = conn.prepareStatement(requete);
            rs = ps.executeQuery();
    ...
    private void calculerDuree(Date dateDepart, Date dateRetour) {
    if (dateDepart != null && dateRetour != null) {
        long differenceEnMillis = dateRetour.getTime() - dateDepart.getTime();
        duree = (float) TimeUnit.DAYS.convert(differenceEnMillis, TimeUnit.MILLISECONDS);
        System.out.println("Durée : " + duree + " jours");
    } else {
        System.out.println("Les dates de départ et de retour ne sont pas valides.");
    }
}
